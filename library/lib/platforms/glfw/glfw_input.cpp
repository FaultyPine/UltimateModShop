...
static const size_t GLFW_GAMEPAD_TO_KEYBOARD[GLFW_GAMEPAD_BUTTON_MAX] = {
    ...
    GLFW_KEY_LEFT_BRACKET, // GLFW_GAMEPAD_BUTTON_LEFT_BUMPER
    GLFW_KEY_RIGHT_BRACKET, // GLFW_GAMEPAD_BUTTON_RIGHT_BUMPER
    ...
    GLFW_KEY_1, // GLFW_GAMEPAD_BUTTON_LEFT_THUMB
    GLFW_KEY_2, // GLFW_GAMEPAD_BUTTON_RIGHT_THUMB
